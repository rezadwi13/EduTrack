        ...
        <div class="bg-white rounded-lg shadow p-8">
            ...
            <form action="{{ route('galeri.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                    <div class="flex items-center">
                        ...
                        <p class="text-sm text-blue-800">
                            Upload foto untuk galeri sekolah. Foto akan ditampilkan di halaman galeri untuk semua pengguna.
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                    ...
                    <div>
                        <label class="block text-gray-700 text-sm font-semibold mb-2">Pilih File Foto</label>
                        <input type="file" 
                               name="gambar" 
                               accept="image/*"
                               class="block w-full text-sm text-gray-700 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200" 
                               required>
                        @error('gambar')
                            <div class="text-red-600 text-sm mt-1 flex items-center">
                                <i class="fas fa-exclamation-circle mr-1"></i>
                ...
                <div>
                    ...
                    <textarea name="deskripsi" 
                              rows="4"
                              class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200" 
                              placeholder="Jelaskan tentang foto ini...">{{ old('deskripsi') }}</textarea>
                    @error('deskripsi')
                        <div class="text-red-600 text-sm mt-1 flex items-center">
                            <i class="fas fa-exclamation-circle mr-1"></i>
                            {{ $message }}
