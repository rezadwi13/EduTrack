        ...
        <div class="bg-white rounded-lg shadow p-8">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                ...
                <div class="flex flex-wrap gap-2">
                    <a href="{{ route('users.show', $user) }}" class="inline-flex items-center gap-2 px-4 py-2 bg-purple-600 text-white rounded hover:bg-purple-700 transition">
            ...
            <form action="{{ route('users.update', $user->id) }}" method="POST" class="space-y-6">
                ...
                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
                    <div class="flex items-center">
                        ...
                        <p class="text-sm text-yellow-800">
                            Edit informasi user "{{ $user->name }}". Perubahan akan langsung tersimpan.
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <div class="flex items-center mb-2">
                        ...
                        <p class="text-sm font-medium text-blue-800">Info Akun Anda</p>
                    </div>
                    <p class="text-xs text-blue-700">
                        Anda sedang mengedit akun sendiri. Perubahan akan langsung mempengaruhi sesi login Anda.
                    </p>
                </div>
                @endif
                ...
                <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                    <div class="flex items-center mb-2">
                        ...
                        <p class="text-sm font-medium text-green-800">Data Terkait</p>
                    </div>
                    <p class="text-xs text-green-700">
                        @if($user->siswa)
                            User ini memiliki data siswa terkait. Perubahan role mungkin mempengaruhi akses data.
                        @elseif($user->guru)
                            User ini memiliki data guru terkait. Perubahan role mungkin mempengaruhi akses data.
                        @endif
                    </p>
                </div>
                @endif
                ...
                <div class="flex gap-3 pt-4">
                    ...
                    <a href="{{ route('users.show', $user) }}" class="flex-1 bg-gray-500 hover:bg-gray-700 text-white font-semibold py-2 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center gap-2">
